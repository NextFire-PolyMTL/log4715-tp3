...
public class Dialogue_PlayerControler : MonoBehaviour
{
    // Déclaration des constantes
    private static readonly Vector3 FlipRotation = new Vector3(0, 180, 0);
    private static readonly Vector3 CameraPosition = new Vector3(5, 1, 0);
    private static readonly Vector3 InverseCameraPosition = new Vector3(-5, 1, 0);
