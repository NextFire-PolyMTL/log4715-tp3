...
[RequireComponent(typeof(P2Niveau_PlayerControler))]
public class P2FreezeOnIce : MonoBehaviour
{
    private P2Niveau_PlayerControler _pc;
    ...
    void Awake()
    {
        _pc = GetComponent<P2Niveau_PlayerControler>();
    }
