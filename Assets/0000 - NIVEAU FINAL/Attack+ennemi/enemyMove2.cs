...
public class enemyMove2 : MonoBehaviour
{
    ...
    [SerializeField] GameObject ownobj;
    ...
    private bool lance_mort=false;
    private bool lance_tourne=false;
    ...
    void Awake()
    {
        ...
        scripts=GameObject.Find("Top/Characters/garde1");
    }
    ...
    void Update()
    {
        lance_mort=scripts.GetComponent<DialogueScriptSoldat>().lance_mort;
        if (lance_tourne!=scripts.GetComponent<DialogueScriptSoldat>().lance_tourne){
            changement=true;
    ...
    */
    ...
    {
        //Debug.Log(vision.gameObject.name=="MaleFree1");
        if (vision.gameObject.tag == "Hero" && fire_on_target && lance_mort)
        {
